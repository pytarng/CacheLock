 ...
 * It supports <a href="http://redis.io/">Redis</a> (with <a href="https://github.com/xetorthio/jedis">Jedis</a> client)
 * , Redis cluster, and <a href="http://memcached.org/">Memcached</a>
 * (with <a href="https://github.com/couchbase/spymemcached">spymemcached</a> client) by default.
 * <p>
...
public class LockSmith {
     ...
     *
     * @param config User defined configuration settings
     * @see com.pytsoft.cachelock.core.Configuration
     */
     ...
     *
     * @param lock Lock target with all required information (such as key, cache server, ...) inside
     *             (check {@linkplain com.pytsoft.cachelock.beans.CacheLock})
     * @throws LockFailedException If any of the following is true:
     *                             <ul>
